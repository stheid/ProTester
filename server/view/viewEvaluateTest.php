					...
					<div class="panel panel-info">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="panel-body">
								...
								<form action='../controller/TestManager.php' method="post"
									size="2">
									<div align="right">
								
								</form>
								<input style="width: 2em" type="points" id="1" points="points"
									onchange="checkFilled();">/3
							...
							<p class="bg-info" style="width: 100%" disabled="disabled">Critarias:
								...
								that we call human existence. You know — all mystics — Catholic,
								Christian, non-Christian, no matter what their theology, no
								matter what their religion — are unanimous on one thing: that
								all is well, all is well. Though everything is a mess, all is
								well. Strange paradox, to be sure. But, tragically, most people
								never get to see that all is well because they are asleep. They
								are having a nightmare.</p>
						</div>
					</div>
				</div>

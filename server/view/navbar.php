	...
	<div class="container-fluid">
		...
		<div class="navbar-header navbar-right">
			<ul class="nav navbar-nav">
				<li><a href="<?php echo PATH; ?>server/controller/LoginController.php"> <?php if(isset($_SESSION['username'])) echo $_SESSION['username']; ?> <span class="glyphicon glyphicon-user"
